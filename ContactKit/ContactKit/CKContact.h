...
@interface CKContact : NSObject

@property (nonatomic, readonly) CKContactField fieldMask;
...
- (id)initWithRecordRef:(ABRecordRef)recordRef fieldMask:(CKContactField)fieldMask;
